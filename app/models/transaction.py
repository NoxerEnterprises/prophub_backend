...
class Transaction(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    payment_type: Mapped[str] = mapped_column(String(60), default=TransactionType.AGENT_SUBSCRIPTION.value, index=True, nullable=False)
    ...
    subscription_duration_months: Mapped[int] = mapped_column(default=12, nullable=False)
    ...
    agent: Mapped[AgentProfile] = relationship("AgentProfile", lazy="selectin", foreign_keys=[agent_id])
